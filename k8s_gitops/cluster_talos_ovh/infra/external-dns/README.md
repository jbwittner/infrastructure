...
```bash
# External DNS secret
cat k8s_gitops/cluster_talos_ovh/infra/external-dns/resources/extra-dns.secret.yaml | \
  kubeseal --controller-namespace sealed-secrets \
  --controller-name sealed-secrets \
  --format yaml > k8s_gitops/cluster_talos_ovh/infra/external-dns/resources/extra-dns.sealed-secret.yaml
